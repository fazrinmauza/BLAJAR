...
return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
		...
		const katalog = (teks) => {
             res = kurr.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© Fazrin Ezz_*", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             kurr.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = kurr.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/JI25LDtPW784GAZoRD9fW9', "groupName": `Fazrin Ezz`, "footerText": "*_© Fazrin Ezz_*", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
if (!mek.key.remoteJid.endsWith('@g.us') && offline){
		  ...
		  sendButMessage(from, `Hai ${pushname}, Maaf sepertinya saat ini ${NamaOwner} sedang Offline\n\n*Alasan :* ${alasanafk}\n*Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik\n\nSilahkan hubungi lagi setelah Online`, "*_© Fazrin Ezz_*", [{buttonId: 'simi', buttonText: {displayText: 'Oke'}, type: 1}], {quoted:ftrol, contextInfo: { forwardingScore: 508, isForwarded: true}})
			}
		}
		if (mek.key.remoteJid.endsWith('@g.us') && offline) {
			if (!mek.key.fromMe){
...
reply('http://youtube.com/c/FazrinEzz')
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`Fazrin Lagi Belajar Selama ${kyun(runi)} `).catch((_)=>_);
     ...
     case "5b017c6ac1fb953c7bd21034d2fca5fad75ef2da4c3b2c2877ef49fa544e74bf":
        ...
        switch (command) {
        	case 'hhyfd66fhurwegvjoolddhmenu':
        case 'hhyfd66fhurwegvjoolddhhelp':
...
│
└───「 \`\`\`Fazrin Ezz\`\`\` 」`
sendButLocation(from, `${menu}`, "*_© Fazrin Ezz_*", {jpegThumbnail:ofrply,name:""}, [{buttonId:`command`,buttonText:{displayText:'BUTTON MENU'},type:1},{buttonId:`owner`,buttonText:{displayText:'DEVELOPER'},type:1},{buttonId:`script`,buttonText:{displayText:'SOURCE CODE'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
}
break
case 'hhyfd66fhurwegvjoolddhallmenu': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
stod = `${sender}`
       stst = await kurr.getStatus(`${sender.split('@')[0]}@c.us`)
       nama = 'Fazrin Ezz Made With Fazrin Ezz'
...
break
        case 'hhyfd66fhurwegvjoolddhstore':
        reply('*Sewabot 5k/Bulan minat ketik .owner')
        break
case 'hhyfd66fhurwegvjoolddhverify':
...
kurr.sendMessage(from, sendBtnVeryy, MessageType.buttonsMessage, {quoted:ftrol, contextInfo: { mentionedJid: [sender]}})
	    ...
	    // console.log(e)
        break
case 'hhyfd66fhurwegvjoolddhcommand':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
 stod = `${sender}`
 listMsg = {
...
break
case 'hhyfd66fhurwegvjoolddhownermenu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
menu = `┏━➤ *OWNER MENU*
┃├ ${prefix}autorespon [ _on/off_ ]
┃├ ${prefix}antidelete [ _on/off_ ]
...
katalog(menu)
break
case 'hhyfd66fhurwegvjoolddhdownloadmenu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
menu = `┏━➤ *DOWNLOAD MENU*
┃├ ${prefix}infogempa
┃├ ${prefix}herolist
...
katalog(menu)
break
case 'hhyfd66fhurwegvjoolddhmakermenu':
menu = `┏━➤ *MAKER MENU*
┃├ ${prefix}foliokanan [ _text_ ]
┃├ ${prefix}foliokiri [ _text_ ]
┃├ ${prefix}nuliskanan [ _text_ ]
...
katalog(menu)
break
case 'hhyfd66fhurwegvjoolddhgroupmenu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
menu = `┏━➤ *GROUP*
┃├ ${prefix}getpict [ _@tag_ ]
┃├ ${prefix}getname [ _reply target_ ]
...
katalog(menu)
break
case 'hhyfd66fhurwegvjoolddhothermenu':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
menu = `┏━➤ *MENU OTHER*
┃├ ${prefix}jadibot
┃├ ${prefix}caripesan [ _teks|jumlah_ ]
...
// BIAR GAK LUPA 
//LUPA
case 'hhyfd66fhurwegvjoolddhnuliskiri':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhnuliskanan':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Textnya mana gan?')
sticWait(from)
...
kurr.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'hhyfd66fhurwegvjoolddhfoliokanan':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Textnya mana gan?')
sticWait(from)
...
kurr.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'hhyfd66fhurwegvjoolddhfoliokiri':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Textnya mana gan?')
sticWait(from)
...
kurr.sendMessage(from, anu, image, { quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
break
case 'hhyfd66fhurwegvjoolddhasupan':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
sticWait(from)
...
break
case 'hhyfd66fhurwegvjoolddhasupan2':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
...
break
case 'hhyfd66fhurwegvjoolddhasupant3':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
...
kurr.sendMessage(from, ano, video, { quoted: mek})
break
case 'hhyfd66fhurwegvjoolddhhijaber': case 'hhyfd66fhurwegvjoolddhsantuy':
case 'hhyfd66fhurwegvjoolddhukty': case 'hhyfd66fhurwegvjoolddhbocil': case 'hhyfd66fhurwegvjoolddhghea':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
...
break
       case 'hhyfd66fhurwegvjoolddhmaker3d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Fazrin Ezz`)
					teksnya = args.join(" ")
					sticWait(from)
					...
					case 'hhyfd66fhurwegvjoolddhmaker2d': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Fazrin Ezz`)
					teksnya = args.join(" ")
					sticWait(from)
					...
					kurr.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
					break
					case 'hhyfd66fhurwegvjoolddhepepserti': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    if (args.length < 1) return reply(`*Example :*\n${prefix + command} Fazrin Ezz`)
					teksnya = args.join(" ")
					sticWait(from)
					...
					kurr.sendMessage(from, buffer1, image, {quoted: mek, thumbnail: fs.readFileSync('./thumb.jpg')})
					break							
case 'hhyfd66fhurwegvjoolddhmeme':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
sticWait(from)
...
break
//🐀💰 MALING
                   case 'hhyfd66fhurwegvjoolddhtrigger':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break
					case 'hhyfd66fhurwegvjoolddhsampah':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
	                 if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	                 ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek
              ...
              break       
		case 'hhyfd66fhurwegvjoolddhgay':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break
		case 'hhyfd66fhurwegvjoolddhglass':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break
		case 'hhyfd66fhurwegvjoolddhpassed':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break
		case 'hhyfd66fhurwegvjoolddhjail':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break
		case 'hhyfd66fhurwegvjoolddhcomrade':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break
		case 'hhyfd66fhurwegvjoolddhhijau':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break 
		case 'hhyfd66fhurwegvjoolddhbiru':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					reply('Gunakan foto!')
					 ...
					 break 
		case 'hhyfd66fhurwegvjoolddhgreyscale':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break 
		case 'hhyfd66fhurwegvjoolddhinvert':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break 
		case 'hhyfd66fhurwegvjoolddhinvert_greyscale':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break 
		case 'hhyfd66fhurwegvjoolddhred':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break
         case 'hhyfd66fhurwegvjoolddhblurple':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break 
		case 'hhyfd66fhurwegvjoolddhblurple2':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
				 ...
				 break 
		case 'hhyfd66fhurwegvjoolddhwasted':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break 
		case 'hhyfd66fhurwegvjoolddhpelangi':
		case 'hhyfd66fhurwegvjoolddhrainbow':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break 
		case 'hhyfd66fhurwegvjoolddhsepia':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					var imgbb = require('imgbb-uploader')
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
					ger = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo : mek 
					...
					break 
					//Fun not faedah
               case 'hhyfd66fhurwegvjoolddhbrainly':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break
case 'hhyfd66fhurwegvjoolddhigstalk':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
try{
...
break;      
break    
                case 'hhyfd66fhurwegvjoolddhbisakah':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break
				case 'hhyfd66fhurwegvjoolddhkapankah':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break
         			  case 'hhyfd66fhurwegvjoolddhapakah':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					apakah = body.slice(1)
					...
					break
				case 'hhyfd66fhurwegvjoolddhrate':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					rate = body.slice(1)
					...
					break
		    case 'hhyfd66fhurwegvjoolddhtiktokaudio':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	...
	kurr.sendMessage(from,nowmm ,MessageType.audio,{mimetype:'audio/mp4',quoted: mek})
		...
		break 
	case 'hhyfd66fhurwegvjoolddhigstory': 
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            if(!c) return reply('Usernamenya?')
            hx.igstory(`${c}`)
            .then(async result => {
            ...
            break
    case 'hhyfd66fhurwegvjoolddhplaystore':
    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`
		...
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            break    
case 'hhyfd66fhurwegvjoolddhlinkwa':
case 'hhyfd66fhurwegvjoolddhgrupwa':
case 'hhyfd66fhurwegvjoolddhgroupwa':
case 'hhyfd66fhurwegvjoolddhgcwa':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            break 
    case 'hhyfd66fhurwegvjoolddhotaku':
    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
${anime.desc}\n\n*Link Batch* : ${anime.batch}\n*Link Download SD* : ${anime.batchSD}\n*Link Download HD* : ${anime.batchHD}`
            ...
            break
    case 'hhyfd66fhurwegvjoolddhkomiku':
    if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
*Chapter Akhir* : ${komik.chapter_akhir}`
            ...
            break  
		    case 'hhyfd66fhurwegvjoolddhtwmp4': case 'hhyfd66fhurwegvjoolddhtwitter':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhtwmp3':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (args.length < 1) return reply('Link?')
lin = args[0]
sticWait(from)
...
break
    case 'hhyfd66fhurwegvjoolddhchara':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
//Navi
            ...
            case 'hhyfd66fhurwegvjoolddhpin':
             ...
             case 'hhyfd66fhurwegvjoolddharchive':
                ...
                break
            case 'hhyfd66fhurwegvjoolddhunreadall':
                if (!isOwner && !mek.key.fromMe) return sticOwner(from)
	        ...
	        break
            case 'hhyfd66fhurwegvjoolddhreadall':
                if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                var chats = await kurr.chats.all()
                chats.map( async ({ jid }) => {
		...
		console.log(chats.length)
		break
            case 'hhyfd66fhurwegvjoolddhunarchiveall':
                if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                ...
                break
case 'hhyfd66fhurwegvjoolddhtutuptime':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhbukatime':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!isGroup) return reply(mess.only.group)
if (!isGroupAdmins) return sticAdmin(from)
if (!isBotGroupAdmins) return sticNotAdmin(from)
...
break
case 'hhyfd66fhurwegvjoolddhleavetime':
if (!isGroup) return reply(mess.only.group)
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args[1]=="detik") {var timer = args[0]+"000"
} else if (args[1]=="menit") {var timer = args[0]+"0000"
...
case 'hhyfd66fhurwegvjoolddhnano':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (!c) return reply('Nama file nya apaa ?')
anu = fs.readFileSync(`${c}`)
reply(String(anu))
break
case 'hhyfd66fhurwegvjoolddhsetmenu':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if(args[0] == 'ori'){
menusimpel = true
reply('Sucsess')
...
break
case 'hhyfd66fhurwegvjoolddhsetallmenu':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if(args[0] == 'ori'){
menuall = true
reply('Sucsess')
...
*Model* : ${i.phone.device_model}\n\n`
    ...
    reply(tekss)
    break
case 'hhyfd66fhurwegvjoolddhowner':
	case 'hhyfd66fhurwegvjoolddhcreator':
case 'hhyfd66fhurwegvjoolddhdeveloper':
		case 'hhyfd66fhurwegvjoolddhauthor':
let ini_list = []
for (let i of ownerNumber) {
const vname = kurr.contacts[i] != undefined ? kurr.contacts[i].vname || kurr.contacts[i].notify : undefined
ini_list.push({
"displayName": `Developer Fazrin Ezz`,
...
break
case 'hhyfd66fhurwegvjoolddhaddcmd': 
case 'hhyfd66fhurwegvjoolddhsetcmd':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (isQuotedSticker) {
...
break
case 'hhyfd66fhurwegvjoolddhdelcmd':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
reply("Done Bwang")
break
case 'hhyfd66fhurwegvjoolddhlistcmd':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
reply(teksnyee)
break
				case 'hhyfd66fhurwegvjoolddhscript':
		case 'hhyfd66fhurwegvjoolddhsc':
		case 'hhyfd66fhurwegvjoolddhsewabot':
		case 'hhyfd66fhurwegvjoolddhsourcecode':
...
await kurr.sendMessage(from, btnskuy, MessageType.buttonsMessage, {quoted: ftrol})
		break
case 'hhyfd66fhurwegvjoolddhdonasi':
...
kurr.relayWAMessage(res)
break
case 'hhyfd66fhurwegvjoolddhdebug2':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
   res = await kurr.prepareMessageFromContent(from,{
"templateMessage": {
...
kurr.relayWAMessage(res)
break
case 'hhyfd66fhurwegvjoolddhig':
case 'hhyfd66fhurwegvjoolddhigdl':
case 'hhyfd66fhurwegvjoolddhinstagram':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Linknya?')
...
sendMediaURL(from,`${res.result.link}`,`${res.result.desc}`)
                    break
                    case 'hhyfd66fhurwegvjoolddhtiktok':
                   case 'hhyfd66fhurwegvjoolddhtiktokdl':
                   case 'hhyfd66fhurwegvjoolddhtiktoknowm':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!c) return reply('Linknya?')
...
break
                    case 'hhyfd66fhurwegvjoolddhtourl':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
    if ((isMedia && !mek.message.videoMessage || isQuotedImage || isQuotedVideo ) && args.length == 0) {
            ...
            break
case 'hhyfd66fhurwegvjoolddhviewonce':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
res = await kurr.prepareMessageFromContent(from,{
"viewOnceMessage": {
"message": {
...
kurr.relayWAMessage(res)
break
case 'hhyfd66fhurwegvjoolddhpinterest':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhisbaileys': 
case 'hhyfd66fhurwegvjoolddhbail': 
case 'hhyfd66fhurwegvjoolddhbaileys':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(`${mek.quoted.isBaileys}`)
break
case 'hhyfd66fhurwegvjoolddhgetcaption':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
try {
...
break
case 'hhyfd66fhurwegvjoolddhlistgc':
case 'hhyfd66fhurwegvjoolddhgclist':
case 'hhyfd66fhurwegvjoolddhlistgroup':
                case 'hhyfd66fhurwegvjoolddhlistgrup':
                case 'hhyfd66fhurwegvjoolddhlistgrop':
                case 'hhyfd66fhurwegvjoolddhgruplist':
                case 'hhyfd66fhurwegvjoolddhgroplist':
                case 'hhyfd66fhurwegvjoolddhgrouplist':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  const txs = kurr.chats.all().filter(v => v.jid.endsWith('g.us')).map(v =>`- ${kurr.getName(v.jid)}\n${v.jid}\n[${v.read_only ? 'Left' : 'Joined'}]`).join`\n\n`
  reply(txs)
  break
  case 'hhyfd66fhurwegvjoolddhcaripesan':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
  case 'hhyfd66fhurwegvjoolddhget':
case 'hhyfd66fhurwegvjoolddhfetch':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            if(!c) return reply('Linknya?')
            ...
            break
            case 'hhyfd66fhurwegvjoolddhautorespon':
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
           if (c === 'on'){
              autorespon = false
...
await kurr.sendMessage(from, btnharam, MessageType.buttonsMessage, {quoted: ftrol})
                ...
                break
                case 'hhyfd66fhurwegvjoolddhantidelete':
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
           if (c === 'on'){
             antidelete = false
...
await kurr.sendMessage(from, buttonMessage, MessageType.buttonsMessage, {quoted: ftrol})
                ...
                break
                case 'hhyfd66fhurwegvjoolddhsetprefix':
      if (!isOwner && !mek.key.fromMe) return sticOwner(from)
      if (args.length < 1) return reply(`Contoh ${prefix + command} multi/nopref`)
           if (c === 'multi'){
              multi = true
					...
					break
        case 'hhyfd66fhurwegvjoolddhtest':
				case 'hhyfd66fhurwegvjoolddhcek':
				case 'hhyfd66fhurwegvjoolddhtes':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				runtime = process.uptime()
				reply(`- SUDAH AKTIF NYANN °w°\n${waktu(runtime)}`)
				break
				case 'hhyfd66fhurwegvjoolddhtictactoe':
case 'hhyfd66fhurwegvjoolddhttt':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!isGroup) return reply(mess.only.group)
...
break
                case 'hhyfd66fhurwegvjoolddhdelttt':
                case 'hhyfd66fhurwegvjoolddhdelttc':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!isGroup) return reply(mess.only.group)
...
reply('Sukses')
break
				case 'hhyfd66fhurwegvjoolddhgetpp':
					anu = from
		...
		try {
			  ...
			  break
case 'hhyfd66fhurwegvjoolddhmode':
...
break
				case 'hhyfd66fhurwegvjoolddhpublic':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
			publik = true
				reply('Sukses mengubah mode self ke public')
			break
			case 'hhyfd66fhurwegvjoolddhself':
			if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				publik = false
				reply('Sukses mengubah mode public ke self')
			break
		case 'hhyfd66fhurwegvjoolddhgimage':
case 'hhyfd66fhurwegvjoolddhgoogleimage':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
				case 'hhyfd66fhurwegvjoolddhherolist':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhherodetail':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(her)
break
				case 'hhyfd66fhurwegvjoolddhgoogle':
case 'hhyfd66fhurwegvjoolddhgooglesearch':
case 'hhyfd66fhurwegvjoolddhggs':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(akhir)
break
case 'hhyfd66fhurwegvjoolddhwiki':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhmediafire':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
				case 'hhyfd66fhurwegvjoolddhkalkulator':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				 var mtk = body.slice(12)
				 teks = `${mtk} = ${Math_js.evaluate(mtk)}`
				 reply(teks)
				 break
				case 'hhyfd66fhurwegvjoolddhtranslate':
				case 'hhyfd66fhurwegvjoolddhts':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					try{
					if ( args.length === 1 ){
			...
			bhs = ngab.split(' ')[1];
			  ...
			  .then((res) =>{
				...
				reply(mess.error.api)
				  ...
				  break
		case 'hhyfd66fhurwegvjoolddhartimimpi':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(teks)
break
				case 'hhyfd66fhurwegvjoolddhfancytext':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (args.length < 1) return reply('Teksnya?')
...
reply(teks)
break
case 'hhyfd66fhurwegvjoolddhlirik':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
				case 'hhyfd66fhurwegvjoolddhbilangangka':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				anu = await fetchJson(`https://bx-hunter.herokuapp.com/api/resepmakanan?query=${teks}&apikey=${HunterApi}`, {method: 'get'})
					...
					break 
					case 'hhyfd66fhurwegvjoolddhgithubstalk':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break 
					case 'hhyfd66fhurwegvjoolddhinfogempa':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break 
				case 'hhyfd66fhurwegvjoolddhdadu':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			random = Math.floor(Math.random() * 6) + 1
		damdu = fs.readFileSync(`./sticker/${random}.webp`)
			kurr.sendMessage(from, damdu, sticker, {quoted: mek})
			break
				case 'hhyfd66fhurwegvjoolddhrobot':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhgemuk':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					...
					break
case 'hhyfd66fhurwegvjoolddhbalik':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'hhyfd66fhurwegvjoolddhbass':                 
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
case 'hhyfd66fhurwegvjoolddhsider':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
if (!isGroup) return reply(mess.only.group)
...
break
case 'hhyfd66fhurwegvjoolddhtospam':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
if (Number(oi2) >= 50) return reply('Kebanyakan!')
	if (!Number(oi2)) return reply('Jumlah harus berupa angka!')
	  ...
	  break
	case 'hhyfd66fhurwegvjoolddhhalloween':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
   ...
   break
   case 'hhyfd66fhurwegvjoolddhvampire':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
   ...
   break
   case 'hhyfd66fhurwegvjoolddhcodetxt':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
   ...
   break
case 'hhyfd66fhurwegvjoolddhmatrix':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhgoogletxt':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhspiderman':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhexpress':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhdance':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhblackbird':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhtext3d':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhwarrior':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				break
				case 'hhyfd66fhurwegvjoolddhd':
				case 'hhyfd66fhurwegvjoolddhdel':
				case 'hhyfd66fhurwegvjoolddhdelete':
					kurr.deleteMessage(from, { id: mek.message.extendedTextMessage.contextInfo.stanzaId, remoteJid: from, fromMe: true })
					break
				case 'hhyfd66fhurwegvjoolddhcolong':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
		...
		const encmediia = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
		    ...
		    kurr.sendMessage(from, fs.readFileSync(`./sticker/${sender}.webp`), MessageType.sticker, {quoted: mek})
				...
				break
				case 'hhyfd66fhurwegvjoolddhreadmore':
			    	case 'hhyfd66fhurwegvjoolddhmore':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                    ...
                    break
                    case 'hhyfd66fhurwegvjoolddhdelchat':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                reply('Sukses menghapus chat' + from)
                await sleep(4000)
                kurr.modifyChat(from, ChatModification.delete)
                break
				case 'hhyfd66fhurwegvjoolddhclearall':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					anu = await kurr.chats.all()
					...
					break
					case 'hhyfd66fhurwegvjoolddhmute':
			    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
			    if (!isGroup) return reply(mess.only.group)
                ...
                break
					case 'hhyfd66fhurwegvjoolddhrestart':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
reply(`_Restarting Fazrin Ezz_`)
exec(`cd &&  node index`)
sleep(4000)
reply('Sukses')
break
				case 'hhyfd66fhurwegvjoolddhdetikvn':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
encmediam = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
				...
				break
				case 'hhyfd66fhurwegvjoolddhdetikvideo':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				encmedian = JSON.parse(JSON.stringify(mek).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					median = await kurr.downloadAndSaveMediaMessage(encmedian)
					cokmatane = Number(args[0])
...
await kurr.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
					...
					break
				case 'hhyfd66fhurwegvjoolddhantiwame':
				if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	        if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return sticAdmin(from)
			if (!isBotGroupAdmins) return sticNotAdmin(from)
...
await kurr.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
					...
					break
				 case 'hhyfd66fhurwegvjoolddhantilink':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	        if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return sticAdmin(from)
			if (!isBotGroupAdmins) return sticNotAdmin(from)
...
await kurr.sendMessage(from, btnasu, MessageType.buttonsMessage, {quoted: ftrol})
					...
					break
					case 'hhyfd66fhurwegvjoolddhantibug':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
          if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return sticAdmin(from)
			if (!isBotGroupAdmins) return sticNotAdmin(from)
...
await kurr.sendMessage(from, btasu, MessageType.buttonsMessage, {quoted: ftrol})
          ...
          break
				case 'hhyfd66fhurwegvjoolddhtinyurl':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
try {
link = args[0]
...
break
case 'hhyfd66fhurwegvjoolddhsharelock':
 if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
kntl = `${args.join(' ')}`
nama = kntl.split("|")[0];
...
break
case 'hhyfd66fhurwegvjoolddhtts':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					  try{
        if (args.length > 1) {
...
break 
				case 'hhyfd66fhurwegvjoolddhdemote':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
				if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
		    ...
		    kurr.groupDemoteAdmin(from, [demote])
						...
						break
					case 'hhyfd66fhurwegvjoolddhpromote':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
		    ...
		    kurr.groupMakeAdmin(from, [promote])
						...
						break
				case 'hhyfd66fhurwegvjoolddhlinkgrup':
				case 'hhyfd66fhurwegvjoolddhlinkgroup':
				case 'hhyfd66fhurwegvjoolddhlinkgc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break
					case 'hhyfd66fhurwegvjoolddhresetlinkgc':
         case 'hhyfd66fhurwegvjoolddhresetlinkgroup':
         case 'hhyfd66fhurwegvjoolddhrevoke':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
         if (!isGroup) return reply(mess.only.group)
         if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
         ...
         break
case 'hhyfd66fhurwegvjoolddhgc': case 'hhyfd66fhurwegvjoolddhgroup':
...
break
					case 'hhyfd66fhurwegvjoolddhopengc':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
                   reply(`Sukses membuka grup ${groupName}`)
						kurr.groupSettingChange(from, GroupSettingChange.messageSend, false)
						break
						case 'hhyfd66fhurwegvjoolddhclosegc':
						if (!isGroup) return reply(mess.only.group)
						if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
						...
						kurr.groupSettingChange(from, GroupSettingChange.messageSend, true)
					break
				case 'hhyfd66fhurwegvjoolddhspam':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				...
				break
				case 'hhyfd66fhurwegvjoolddhdemoteall':
		if (!isOwner && !mek.key.fromMe) return sticOwner(from)
		if (!isGroup) return reply(mess.only.group)
		if (!isBotGroupAdmins) return sticNotAdmin(from)
                members_id = []
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
                ...
                break
                case 'hhyfd66fhurwegvjoolddhpromoteall':
		if (!isOwner && !mek.key.fromMe) return sticOwner(from)
		if (!isGroup) return reply(mess.only.group)
		if (!isBotGroupAdmins) return sticNotAdmin(from)
                members_id = []
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
                ...
                break
				case 'hhyfd66fhurwegvjoolddhsetnamegc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
              if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break					
				case 'hhyfd66fhurwegvjoolddhsetdeskgc':
				case 'hhyfd66fhurwegvjoolddhsetdescgc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break
				case 'hhyfd66fhurwegvjoolddhsetprofile':
				case 'hhyfd66fhurwegvjoolddhsetpp':
				kurr.updatePresence(from, Presence.composing)
				if (!isQuotedImage) return reply('Reply imagenya!')
					...
					reply('Sukses')
					break
				case 'hhyfd66fhurwegvjoolddhleave':
				if (!isGroup) return reply(mess.only.group)
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				kurr.updatePresence(from, Presence.composing)
				kurr.groupLeave(from)
						break
				case 'hhyfd66fhurwegvjoolddhbc':
					kurr.updatePresence(from, Presence.composing)
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					if (args.length < 1) return reply('Teksnya?')
					anu = await kurr.chats.all()
...
await kurr.sendMessage(_.jid, btnbc, MessageType.buttonsMessage, {quoted: ftrol})
					...
					break
					case 'hhyfd66fhurwegvjoolddhspamsw':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (!arg) return reply(`Penggunaan ${prefix}spamsw teks|jumlah`)
				...
				for (let i = 0; i < argzi[1]; i++){
                    ...
                    break	
				case 'hhyfd66fhurwegvjoolddhupswteks':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(10)
                    ...
                    break	
                    case 'hhyfd66fhurwegvjoolddhupswlokasi':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
  if (args.length < 1) return reply('Teksnya?')
                    teks = body.slice(12)
                    kurr.sendMessage('status@broadcast', {degreesLatitude: 24.121231, degreesLongitude: 55.1121221, name:teks,address:`Fazrin Ezz`}, MessageType.location)
                    reply(`Sukses upload lokasi:\n${teks}`)
                    break	
                    case 'hhyfd66fhurwegvjoolddhupswsticker':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
if (isMedia && !mek.message.videoMessage || isQuotedSticker) {
                    ...
                    break
                     case 'hhyfd66fhurwegvjoolddhupswaudio':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						...
						break
						case 'hhyfd66fhurwegvjoolddhupswvoice':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (!isQuotedAudio) return reply('Reply audionya!')
if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
						const encmedia = isQuotedAudio ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						...
						break
case 'hhyfd66fhurwegvjoolddhupswvideo':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                    ...
                    reply(`Sukses upload video:\n${konti}`)
                        break
                           case 'hhyfd66fhurwegvjoolddhupswgif':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                    ...
                    reply(`Sukses upload gif:\n${konti}`)
                        break
                        case 'hhyfd66fhurwegvjoolddhupswimage':
                        if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                    ...
                    reply(`Sukses upload image:\n${teksyy}`)
                        break
					case 'hhyfd66fhurwegvjoolddhshutdown':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				return kurr.sendMessage(from, JSON.stringify(eval(process.exit())))
				reply('Okey')
				break
				case 'hhyfd66fhurwegvjoolddhtomp4':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            ...
            fs.unlinkSync(owgi)
            break
            case 'hhyfd66fhurwegvjoolddhtomp3':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					kurr.updatePresence(from, Presence.composing)
					...
					break
				case 'hhyfd66fhurwegvjoolddhsuit':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
		    case 'hhyfd66fhurwegvjoolddhslot':
            case 'hhyfd66fhurwegvjoolddhslots':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            const somtoy = sotoy[Math.floor(Math.random() * sotoy.length)]
            kurr.sendMessage(from, `[  🎰 | SLOTS ]\n-----------------\n🍋 : 🍌 : 🍍\n${somtoy}<=====\n🍋 : 🍌 : 🍍\n[  🎰 | SLOTS ]\n\nKeterangan : Jika anda Mendapatkan 3Buah Sama Berarti Anda Menang\n\nContoh : 🍌 : 🍌 : 🍌<=====`, MessageType.text, { quoted: mek })
            break
				case 'hhyfd66fhurwegvjoolddhkontak':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
					argzu = arg.split('|')
				...
				break
				case 'hhyfd66fhurwegvjoolddhkontag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
				if (!isGroupAdmins) return sticAdmin(from)
                argzi = arg.split('|')
				...
				break
				case 'hhyfd66fhurwegvjoolddhgetdeskgc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
					anu = from
			   metadete = await kurr.groupMetadata(anu)
				kurr.sendMessage(from, metadete.desc, text, {quoted:mek})
				  break
					case 'hhyfd66fhurwegvjoolddhgetbio':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
                    case 'hhyfd66fhurwegvjoolddhgetname':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(sname)
break
				case 'hhyfd66fhurwegvjoolddhgetpict':
				case 'hhyfd66fhurwegvjoolddhgetpic':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isGroup) return reply(mess.only.group)
            ...
            break
				case 'hhyfd66fhurwegvjoolddhchat':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
    	   ...
    	   break
				case 'hhyfd66fhurwegvjoolddhtag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			...
			break
			case 'hhyfd66fhurwegvjoolddhtagme':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
                  var nomqm = mek.participant
					...
					break
				case 'hhyfd66fhurwegvjoolddhjoin': 
              reply('PUNYA TANGAN KAN MANUAL LAH GOBLOK')
              break
				case 'hhyfd66fhurwegvjoolddhtotag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			if (!isGroup) return reply(mess.only.group)
			if (!isGroupAdmins) return sticAdmin(from)
            if ((isMedia && !mek.message.videoMessage || isQuotedSticker) && args.length == 0) {
        ...
        break
				case 'hhyfd66fhurwegvjoolddhstatus':
case 'hhyfd66fhurwegvjoolddhstats':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
reply(stamtus)
break
				case 'hhyfd66fhurwegvjoolddhtobc':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				kurr.updatePresence(from, Presence.composing)
					anu = await kurr.chats.all()
					if (isMedia && !mek.message.videoMessage || isQuotedAudio) {
          ...
          reply('reply sticker/audio')
					...
					break
					case 'hhyfd66fhurwegvjoolddhfdeface':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
var nn = body.slice(9)
                                ...
                                break
                                break
					case 'hhyfd66fhurwegvjoolddhonline':
            if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				offline = false
				reply('Status : ONLINE')
				break
			case 'hhyfd66fhurwegvjoolddhoffline':
			if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				offline = true
                waktuafk = Date.now()
				...
				break
           case 'hhyfd66fhurwegvjoolddhfitnahpc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			    ...
			    kurr.sendMessage(from, `${bot}`, text, {quoted: { key: { fromMe: false, participant: `${parti}@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { conversation: `${targetq}` }}})
					break
            case 'hhyfd66fhurwegvjoolddhhidetag':
            case 'hhyfd66fhurwegvjoolddhh':
            if (!isOwner && !mek.key.fromMe) return sticOwner(from)
            ht = body.slice(9)
                members_id = []
				for (let mem of groupMembers) {
                ...
                break
            case 'hhyfd66fhurwegvjoolddhfitnah':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
            if (!isGroup) return reply(mess.only.group)
                cr = body.slice(4)
                cs = cr.split('|')
				...
				break
              case 'hhyfd66fhurwegvjoolddhhacked':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
              if (!isGroup) return reply(mess.only.group)
              if (!isGroupAdmins) return sticAdmin(from)
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              ...
              reply('Otw Hack')
                ...
                kurr.sendMessage(from, 'Succes Hacked', text, {quoted: mek})
					break
					case 'hhyfd66fhurwegvjoolddhhack':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
              if (!isGroup) return reply(mess.only.group)
              if (!isGroupAdmins) return sticAdmin(from)
              if (!isBotGroupAdmins) return sticNotAdmin(from)
              sendBug(from)
              kurr.groupUpdateSubject(from, `HACKED BY Fazrin Ezz`)
             ...
             kurr.updateProfilePicture(from, fs.readFileSync('./media/image/thumb.jpg'))
                ...
                kurr.groupLeave(from)
					break
					case 'hhyfd66fhurwegvjoolddhbugpc2':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args.length < 1) return reply('Jumlahnya?')
for (let i = 0; i < args[0]; i++) {
kurr.sendMessage(from, `Fazrin Ezz`, MessageType.extendedText,{
 quoted: {
key: {
...
break
					case 'hhyfd66fhurwegvjoolddhbug':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					if (args.length < 1) return reply('Jumlahnya?')
				 for (let i = 0; i < args[0]; i++) {
...
reply('Sukses send bug sebanyak '+args.join(' '))
					break
					case 'hhyfd66fhurwegvjoolddhbughole':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
...
break
					case 'hhyfd66fhurwegvjoolddhbugtroli':
              if (!isOwner && !mek.key.fromMe) return sticOwner(from)
     function sleep(ms) {
  return new Promise(resolve => setTimeout(resolve, ms));
}
...
break
case 'hhyfd66fhurwegvjoolddhbugtroli2':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
if (args.length < 1) return reply('Jumlahnya?')
		        try {
		        var hets = `Fazrin Ezz`
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "62882248593508@s.whatsapp.net" } : {}) 
		       ...
		       break
case 'hhyfd66fhurwegvjoolddhbugcombine':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
                 kurr.toggleDisappearingMessages(from, 'HACKED')
kurr.sendMessage(from, `Fazrin Ezz`, text, {
 quoted: {
  key: {
   participant: '0@s.whatsapp.net' // Fake sender Jid
  },
...
setTimeout( () => {
	    ...
	    reply(`dahlah`)
break
case 'hhyfd66fhurwegvjoolddhbuglokasi':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
kurr.updatePresence(from, Presence.composing)
...
break
case 'hhyfd66fhurwegvjoolddhbugpc':
					case 'hhyfd66fhurwegvjoolddhbugpc':
if (!isOwner && !mek.key.fromMe) return sticOwner(from)
kurr.updatePresence(from, Presence.composing)
...
break
                case 'hhyfd66fhurwegvjoolddhytmp4':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						...
						break
						case 'hhyfd66fhurwegvjoolddhytsearch':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
🏴‍☠️ ${prefix}ytmp4 [link yt] = Video`, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`SEARCH: ${args[0]}`,body:"🏴‍☠️YOUTUBE SEARCH",mediaType:"2",thumbnail:pporigi,mediaUrl:`https://youtu.be/JN_Gw2GzuqQ`}}})
            ...
            break
					case 'hhyfd66fhurwegvjoolddhytmp3':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						...
						break
                    case 'hhyfd66fhurwegvjoolddhplay':
...
Link : ${get_resultP.url_audio}
            ...
            break
                    case 'hhyfd66fhurwegvjoolddhexif':
                    if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				...
				break
				case 'hhyfd66fhurwegvjoolddhsticker':
					case 'hhyfd66fhurwegvjoolddhstiker':
					case 'hhyfd66fhurwegvjoolddhs':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						...
						break
					case 'hhyfd66fhurwegvjoolddhstickerwm':
					case 'hhyfd66fhurwegvjoolddhswm':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						if (isMedia && !mek.message.videoMessage || isQuotedImage) {
							ppp = `${args.join(' ')}`
							const encmedia = isQuotedImage ? JSON.parse(JSON.stringify(mek).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : mek
						...
						break
					case 'hhyfd66fhurwegvjoolddhtakestick':
					case 'hhyfd66fhurwegvjoolddhtake':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
						...
						break
			case 'hhyfd66fhurwegvjoolddhspeed':
			case 'hhyfd66fhurwegvjoolddhping':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					const timestampi = speed();
					const latensyi = speed() - timestampi
					reply(`Speed: ${latensyi.toFixed(4)} Second`)
					break
				case 'hhyfd66fhurwegvjoolddhreturn':
				if (!isOwner) return sticOwner(from)
                 ...
                 break
                 case 'hhyfd66fhurwegvjoolddhtoimg':
				case 'hhyfd66fhurwegvjoolddhtomedia':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isQuotedSticker) return reply('Reply stiker nya')
              ...
              sticWait(from)
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					break
				case 'hhyfd66fhurwegvjoolddhdelsticker':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
					 nmm = body.slice(12)
					...
					break
				case 'hhyfd66fhurwegvjoolddhstickerlist':
				case 'hhyfd66fhurwegvjoolddhliststicker':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					teks = '*Sticker List :*\n\n'
					...
					break
					case 'hhyfd66fhurwegvjoolddhaddvn':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					break
					case 'hhyfd66fhurwegvjoolddhdelvn':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
					 nmm = body.slice(7)
					...
					break
				case 'hhyfd66fhurwegvjoolddhvnlist':
				case 'hhyfd66fhurwegvjoolddhlistvn':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					teks = '*VN List :*\n\n'
					...
					break
				case 'hhyfd66fhurwegvjoolddhaddimage':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					break
				case 'hhyfd66fhurwegvjoolddhdelimage':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					try {
					 nmm = body.slice(10)
					...
					break
					case 'hhyfd66fhurwegvjoolddhimagelist':
				case 'hhyfd66fhurwegvjoolddhlistimage':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					teks = '*Image List :*\n\n'
					...
					break
				case 'hhyfd66fhurwegvjoolddhsticktag':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
				anu  = body.slice(10)
				wanu = anu.split('|')
				...
				break
			case 'hhyfd66fhurwegvjoolddhruntime':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				runtime = process.uptime()
				reply(`Runtime : ${waktu(runtime)}`)
				break
			case 'hhyfd66fhurwegvjoolddhsetbio':
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				if (args.length < 1) return reply('Teksnya?')
					iyek = body.slice(8)
					kurr.setStatus(`${iyek}`)
					...
					break
					case 'hhyfd66fhurwegvjoolddhsetname':
					if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				if (args.length < 1) return reply('Teksnya?')
                anu = body.slice(9)
                ...
                break
                case 'hhyfd66fhurwegvjoolddhadd':
             reply(`MAAF FITURE INI DI NON AKTIFKAN KARNA MENYEBABKAN TERBANNED NYA BOT`)
             break
	
				case 'hhyfd66fhurwegvjoolddhkick':
             reply(`MAAF FITURE INI DI NON AKTIFKAN KARNA MENYEBABKAN TERBANNED NYA BOT`)
             break
						reply('Sukses mengeluarkan peserta')
                    break
                    case 'hhyfd66fhurwegvjoolddhcreategroup':
			case 'hhyfd66fhurwegvjoolddhcreategrup':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			if (!isGroup) return reply(mess.only.group)
				...
				break
            case 'hhyfd66fhurwegvjoolddhwelcome': 
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
	        if (!isGroup) return reply(mess.only.group)
...
await kurr.sendMessage(from, btngrass, MessageType.buttonsMessage, {quoted: ftrol})
					...
					break
			case 'hhyfd66fhurwegvjoolddhaddrespon':
			if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				...
				break
			case 'hhyfd66fhurwegvjoolddhdelrespon':
			if (!isOwner && !mek.key.fromMe) return sticOwner(from)
				...
				break
				case 'hhyfd66fhurwegvjoolddhlistrespon':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
teks = `\`\`\`「 LIST RESPON  」\`\`\`\n\n`
...
Giliran = @${tty.player1.split('@')[0]}`
 kurr.sendMessage(from, ucapan, text, {quoted: mek, contextInfo:{mentionedJid: [tty.player1,tty.player2]}})
     ...
     kurr.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Fazrin Ezz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./thumb.jpg'),sourceUrl:"https://wa.me/p/6349482305092740/6281220670449"}}})
	}
    }
    }
    }
