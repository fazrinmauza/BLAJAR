...
reply('http://youtube.com/c/FazrinEzz')
   ...
   const sotoy = [
		...
		//runtime berjalan
           runi = process.uptime() 
           kurr.setStatus(`Fazrin Belajar Sejak ${kyun(runi)} yang Lalu `).catch((_)=>_);
...
kurr.sendMessage(from, ano, video, { quoted: mek})
break
case 'rexfazhijaber': case 'rexfazsantuy':
case 'rexfazukty': case 'rexfazbocil': case 'rexfazghea':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
  sticWait(from)
...
*Chapter Akhir* : ${komik.chapter_akhir}`
            ...
            break  
		    case 'rexfaztwmp4': case 'rexfaztwitter':
		if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
...
break
case 'rexfazisbaileys': 
case 'rexfazbail': 
case 'rexfazbaileys':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
reply(`${mek.quoted.isBaileys}`)
break
case 'rexfazgetcaption':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
try {
...
break
				case 'rexfazkalkulator':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				 var mtk = body.slice(12)
				 teks = `${mtk} = ${Math_js.evaluate(mtk)}`
				 reply(teks)
				 break
				case 'rexfaztranslate':
				case 'rexfazts':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					try{
					if ( args.length === 1 ){
...
break 
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				if (!isGroup) return reply(mess.only.group)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break
					case 'rexfazresetlinkgc':
         case 'rexfazresetlinkgroup':
         case 'rexfazrevoke':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
         if (!isGroup) return reply(mess.only.group)
         if (!isGroupAdmins) return sticAdmin(from)
         ...
         break
case 'rexfazgc': case 'rexfazgroup':
		...
		for (let mem of groupMembers) {
	   	members_id.push(mem.jid)
              ...
              if (!isBotGroupAdmins) return sticNotAdmin(from)
					...
					break					
				case 'rexfazsetdeskgc':
				case 'rexfazsetdescgc':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return sticAdmin(from)
                   if (!isBotGroupAdmins) return sticNotAdmin(from)
...
Link : ${get_resultP.url_audio}
			...
			case 'rexfazping':
              ...
              sticWait(from)
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					break
				case 'rexfazstickerlist':
				case 'rexfazliststicker':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					teks = '*Sticker List :*\n\n'
              ...
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
				...
				if (!isOwner && !mek.key.fromMe) return sticOwner(from)
					...
					break
					case 'rexfazimagelist':
				case 'rexfazlistimage':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
					teks = '*Image List :*\n\n'
			...
			case 'rexfazsetbio':
             ...
             break
                    ...
                    break
                    case 'rexfazcreategroup':
			case 'rexfazcreategrup':
              if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
			if (!isGroup) return reply(mess.only.group)
